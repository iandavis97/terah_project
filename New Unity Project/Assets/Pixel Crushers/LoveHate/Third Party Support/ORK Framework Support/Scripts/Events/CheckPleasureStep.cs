...
namespace ORKFramework.Events.Steps
{
	...
	[ORKEditorHelp("Check Pleasure", "Which steps will be executed next is decided by a faction member's pleasure value.", "")]
	[ORKEventStep(typeof(BaseEvent))]
	[ORKNodeInfo("Love\u2215Hate Steps")]
	public class CheckPleasureStep : BaseEventCheckStep
	{
		...
		public override void Execute(BaseEvent baseEvent)
		{
			...
			{
				Debug.LogWarning("Love/Hate: CheckPleasure - Can't find faction member");
			}
			else
			{
