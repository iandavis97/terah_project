...
namespace ORKFramework.Events.Steps
{
	...
	[ORKEditorHelp("Check Happiness", "Which steps will be executed next is decided by a faction member's happiness value.", "")]
	[ORKEventStep(typeof(BaseEvent))]
	[ORKNodeInfo("Love\u2215Hate Steps")]
	public class CheckHappinessStep : BaseEventCheckStep
	{
		...
		public override void Execute(BaseEvent baseEvent)
		{
			...
			{
				Debug.LogWarning("Love/Hate: CheckHappiness - Can't find faction member");
			}
			else
			{
