...
namespace ORKFramework.Events.Steps
{
	...
	[ORKEditorHelp("Check Dominance", "Which steps will be executed next is decided by a faction member's dominance value.", "")]
	[ORKEventStep(typeof(BaseEvent))]
	[ORKNodeInfo("Love\u2215Hate Steps")]
	public class CheckDominanceStep : BaseEventCheckStep
	{
