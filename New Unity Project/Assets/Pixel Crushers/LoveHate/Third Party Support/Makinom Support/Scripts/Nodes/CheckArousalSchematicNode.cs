...
namespace Makinom.Schematics.Nodes
{
    ...
    [EditorHelp("Check Arousal", "Which steps will be executed next is decided by a faction member's arousal value.", "")]
    [NodeInfo("Love\u2215Hate")]
    public class CheckArousalStep : BaseSchematicCheckNode
    {
        ...
        public override void Execute(Schematic schematic)
        {
            ...
            {
                Debug.LogWarning("Love/Hate: Check Arousal - Can't find faction member");
            }
            else
            {
