...
namespace Makinom.Schematics.Nodes
{
    ...
    [EditorHelp("Check Happiness", "Which steps will be executed next is decided by a faction member's happiness value.", "")]
    [NodeInfo("Love\u2215Hate")]
    public class CheckHappinessStep : BaseSchematicCheckNode
    {
        ...
        public override void Execute(Schematic schematic)
        {
            ...
            {
                Debug.LogWarning("Love/Hate: Check Happiness - Can't find faction member");
            }
            else
            {
                var happiness = factionMember.pad.happiness;
