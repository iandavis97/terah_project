...
namespace Makinom.Schematics.Nodes
{
    ...
    [EditorHelp("Check Dominance", "Which steps will be executed next is decided by a faction member's dominance value.", "")]
    [NodeInfo("Love\u2215Hate")]
    public class CheckDominanceStep : BaseSchematicCheckNode
    {
        ...
        public override void Execute(Schematic schematic)
        {
            ...
            {
                Debug.LogWarning("Love/Hate: Check Dominance - Can't find faction member");
            }
            else
            {
