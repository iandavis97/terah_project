...
namespace Makinom.Schematics.Nodes
{
	...
	[EditorHelp("Check Has Direct Parent", "Which steps will be executed next is decided by whether a faction has a direct parent.", "")]
	[NodeInfo("Love\u2215Hate")]
	public class CheckHasDirectParentStep : BaseSchematicCheckNode
	{
		...
		public override void Execute(Schematic schematic)
		{
			...
			{
				Debug.LogWarning("Love/Hate: Check Has Direct Parent - Can't find faction manager");
			}
			if (factionID == -1)
			{
				Debug.LogWarning("Love/Hate: Check Has Direct Parent - Can't find faction ID");
			}
			else if (parentID == -1)
			{
				Debug.LogWarning("Love/Hate: Check Has Direct Parent - Can't find parent faction ID");
			}
			else
			{
